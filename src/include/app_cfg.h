...
#define ZCL_BASIC_MFG_NAME     {6,'D','E','V','B','I','S'}
#define ZCL_BASIC_MODEL_ID     {14, 'G','P','_','T','e','s','t','_','D','e','v','i','c','e'}
...
/* Board define */
    ...
    /* This TB03F board's flash chip reports 512K (JEDEC ID 0xC86013) -
     * confirmed via TlsrPgm's `i` chip-info readout. FLASH_CAP_SIZE_1M
     * must NOT be set here: drv_hw.c's internalFlashSizeCheck() infinite-
     * loops at boot if the declared capacity doesn't match the real chip. */
